...
if (!norunFlag) {
    ...
    $(document).ready(function () {
        var AIimgSrc = [
            message_Path + "models/kurumi/textures/t1.png",
            message_Path + "models/kurumi/textures/t2.png",
            message_Path + "models/kurumi/textures/t3.png"
        ]
        var images = [];
        ...
        for (var i = 0; i < imgLength; i++) {
            ...
            images[i].onload = function () {
                ...
                if (loadingNum === imgLength) {
                    ...
                    setTimeout(function () {
                        loadlive2d("live2d", message_Path + "models/kurumi/model.json");
                    }, 1000);
                    initLive2d();
                    images = null;
                }
